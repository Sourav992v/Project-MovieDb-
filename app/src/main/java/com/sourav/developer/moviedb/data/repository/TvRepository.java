...
public class TvRepository {
            ...
            protected void saveCallResult(@NonNull TvApiResponse item) {
                ...
                for (TvEntity tvEntity: item.getResults()){
                    ...
                    if (storedTvEntity == null){
                        tvEntity.setCategoryTypes(Arrays.asList(type));
                    }else{
                        List<String> category = storedTvEntity.getCategoryTypes();
                        category.add(type);
                        tvEntity.setCategoryTypes(category);
                    }
    ...
    public Observable<Resource<List<TvEntity>>> fetchTvDetails(Long tvId){
